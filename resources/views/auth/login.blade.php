...
@if($auth == 'Company')
<title> {{ config('app.name') }} | {{ __('admin.Login As Company') }}</title>
@elseif($auth == 'Admin')
<title> {{ config('app.name') }} | {{ __('admin.Login As Admin') }}</title>
@elseif($auth == 'Teacher')
<title> {{ config('app.name') }} | {{ __('admin.Login As Teacher') }}</title>
@else
<title> {{ config('app.name') }} | {{ __('admin.Login As Trainer') }}</title>
@endif
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form method="POST" action="{{ route('login', $type) }}">
                                @csrf
                                @if($auth == 'Company')
                                    <h3>{{ __('admin.Login As Company') }}</h3>
                                @elseif($auth == 'Admin')
                                <h3>{{ __('admin.Login As Admin') }}</h3>
                                @elseif($auth == 'Teacher')
                                <h3>{{ __('admin.Login As Teacher') }}</h3>
                                @else
                                <h3>{{ __('admin.Login As Trainer') }}</h3>
                                @endif
