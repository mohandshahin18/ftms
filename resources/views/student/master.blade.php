    ...
    <section class="bg-light" id="portfolio">
        ...
        <div id="projects-slider" class="owl-theme owl-carousel">
            <div class="project">
                ...
                <img src="{{ asset('studentAssets/img/project1.jpg') }}" alt="">
                <div class="content">
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="{{ asset('studentAssets/img/project3.jpg') }}" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="{{ asset('studentAssets/img/team_1.jpg') }}" alt="">
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="{{ asset('studentAssets/img/team_2.jpg') }}" alt="">
                            <div class="social-icons">
                                <a href="#"><i class='bx bxl-facebook'></i></a>
                                <a href="#"><i class='bx bxl-twitter'></i></a>
                                <a href="#"><i class='bx bxl-instagram'></i></a>
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="{{ asset('studentAssets/img/team_3.jpg') }}" alt="">
                            <div class="social-icons">
                                <a href="#"><i class='bx bxl-facebook'></i></a>
                                <a href="#"><i class='bx bxl-twitter'></i></a>
                                <a href="#"><i class='bx bxl-instagram'></i></a>
                    ...
                    <div class="container-fluid">
                        <div class="row gy-4">
                            <div class="col-lg-4 col-sm-12 bg-cover"
                                style="background-image: url({{ asset('studentAssets/img/c2.jpg') }}); min-height:300px;">
                                <div>
