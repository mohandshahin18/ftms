        ...
        <div class="notification-ui_dd-content">
                    ...
                    <div class="notification-list_content">
                        ...
                        <div style="width: 100%">
                            ...
                            @elseif($student->company_id == null)
                                ...
                                @endphp
                                <div class="btns d-flex justify-content-end">
                                    <form action="{{ route('admin.accept_apply') }}" class="accept_form"
                                        id="form-{{ $notify->data['student_id'] }}">
                                        @csrf
                                        ...
                                        <input type="hidden" name="category_id" value="{{ $notify->data['category_id'] }}"
                                            id="">
                                        <button type="button" class="btn btn-success accept_btn"></i>
                                    ...
                                    <form action="{{ route('admin.reject_apply', $notify->id) }}" method="POST">
                                        ...
                                        <input type="hidden" name="category_id" value="{{ $notify->data['category_id'] }}"
                                            id="">
                                        <button type="button" class="btn btn-danger reject_btn">
            ...
            @empty
                <div class="text-center">
                    <img src="{{ asset('studentAssets/img/notifications-removebg-preview.webp') }}"
                        class="img-responsive empty-state-img" alt="">
